  ...
  return (
    <div className="aurora-bg flex min-h-screen items-center justify-center px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">This route doesn't exist in the agent graph.</p>
        <div className="mt-6">
    ...
    <div className="aurora-bg flex min-h-screen items-center justify-center px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a href="/" className="rounded-md border border-border px-4 py-2 text-sm font-medium hover:bg-secondary">Home</a>
        </div>
      </div>
    </div>
  );
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Futuristic multi-agent AI platform for medical & research document intelligence." },
      { property: "og:title", content: "Nexus — Multi-Agent AI Intelligence" },
      { property: "og:description", content: "Upload, classify, and analyze documents with collaborative AI agents in realtime." },
